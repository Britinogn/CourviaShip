      ...
      <div v-else-if="shipments.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <div class="p-6">
            ...
            <!-- Actions -->
            <!-- Added: View button, links to the shipment details page by trackingId -->
            <div class="flex gap-3">
              <NuxtLink
                :to="`/dashboard/shipments-details/${shipment.trackingId}`"
                class="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-all font-semibold group"
              >
