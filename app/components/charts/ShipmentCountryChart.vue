<template>
  <div class="h-full flex flex-col gap-5 sm:gap-6 py-2 overflow-y-auto">
    ...
    <div>
      ...
      <div class="flex flex-col gap-2.5">
        <div
          v-for="item in dashboardStore.overview?.topOrigins"
          :key="item.country"
    ...
    <div>
      ...
      <div class="flex flex-col gap-2.5">
        <div
          v-for="item in dashboardStore.overview?.topDestinations"
          :key="item.country"
          class="flex items-center gap-2 sm:gap-3"
        >
          <span class="text-xs text-gray-600 w-20 sm:w-28 shrink-0 truncate">
    ...
    <div
      v-if="!dashboardStore.overview?.topOrigins?.length"
